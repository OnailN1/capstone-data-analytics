...
### **Important Note: This Housing Affordability Analysis used Power Query for Linear Regression Model and data cleaning, data merging and data modeling. This process is in the Power BI Modeling and Data Documentation.pdf file.**
